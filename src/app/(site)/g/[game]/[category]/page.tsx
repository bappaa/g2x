...
export default async function Page({
  ...
  return (
    <main className="mx-auto max-w-[1220px] px-3 py-4 sm:px-4 sm:py-6">
      ...
      <div className="mt-4 grid gap-4 lg:grid-cols-[236px_1fr] lg:gap-5">
        <GameRail
        ...
        <div className="space-y-5">
          <div className="flex flex-wrap items-center gap-3 rounded-2xl panel p-4 sm:gap-4 sm:p-5">
            ...
            <div className="min-w-0 flex-1">
              <h1 className="text-[18px] font-black tracking-tight sm:text-[22px]">
                {game.name} {cat.name}
              </h1>
